    ...
    <nav className="fixed top-0 w-full bg-white shadow-lg z-50">
      <div className="max-w-6xl mx-auto flex justify-between items-center p-2">
        ...
        ${open ? "flex" : "hidden"}`}>
          ...
          <a href="#about" className="hover:text-yellow-600 py-2">About</a>
          <a href="#menu" className="hover:text-yellow-600 py-2">Menu</a>
          <a href="#services" className="hover:text-yellow-600 py-2">Services</a>
          <a href="#contact" className="hover:text-yellow-600 py-2">Contact</a>
        </div>
